...
LRESULT APIENTRY PrintDlgProc(HWND, UINT, WPARAM, LPARAM);
LRESULT APIENTRY AboutDlgProc(HWND, UINT, WPARAM, LPARAM);
int WINAPI InstallHook (HWND hWnd, BOOL bCode );
BOOL WINAPI HelpDlgProc(HWND, UINT, WPARAM, LPARAM);
LRESULT APIENTRY SavingDlgProc(HWND, UINT, WPARAM, LPARAM);
...
void DoPaint(HWND);
LRESULT CALLBACK SelectDlgProc(HWND, UINT, WPARAM, LPARAM);
LRESULT CALLBACK RectangleDlgProc(HWND, UINT, WPARAM, LPARAM);
